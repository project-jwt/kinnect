...
A voice-first tool for adults 65+: the primary user speaks an issue, AI turns it into a reviewable summary, and the user sends it to a trusted contact or reaches a pre-loaded helpline.
